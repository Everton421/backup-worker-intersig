...
export const pathCliente:FastifyPluginAsyncZod = async (server )=>{
 ...
 async ( request, reply )=>{
        ...
        const {portaMysql, acesso, efetuar_backup, hora_agenda_backup, host,nomeBanco,  senhaMysql,usuarioMysql, caminhoBkp  } = request.body
